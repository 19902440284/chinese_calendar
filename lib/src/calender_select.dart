...
class _CalenderSelectState extends State<CalenderSelect> {
  ...
  Widget build(BuildContext context) {
    ...
    _lunarDayStyle = theme.lunarDayStyle ??
    ...
    return Material(
      child: CalendarView(
        ...
        builderItem: (info, child, month) =>
            _builderItem(context, info, child, month),
  ...
  Widget _builderItem(
      BuildContext context, CalendarInfo info, Widget child, int month) {
    ...
    if (0 == start && null == end) {
      ...
      child = DecoratedBox(
        ...
        -1 == end &&
        (month == info.solarDate.month || _selectOtherDay)) {
      child = DecoratedBox(
        decoration: BoxDecoration(
    ...
    return Column(
      ...
      children: <Widget>[
        Text(
          ...
          style: month == month
              ? _dayStyle.copyWith(color: _selectTextColor)
              : _garyStyle.copyWith(color: _selectTextColor),
        ),
      ]..addAll(_lunary
          ? [
              Text(
...
Future<dynamic> sDateRangePicker({
        ...
        child: SizedBox(
          ...
          child: ClipRRect(
            ...
            child: Material(
              child: Container(
                padding:
                    EdgeInsets.only(top: 24, left: 12, bottom: 12, right: 12),
